...
;(function($) {
    ...
    Transfer.prototype.generate_transfer = function() {
        let html =
			...
			+ '<div class="btn-select-arrow" id="add_selected_' + this.id + '"><i class="glyphicon glyphicon-chevron-right"></i></div>'
            + '<div class="btn-select-arrow" id="delete_selected_' + this.id + '"><i class="glyphicon glyphicon-chevron-left"></i></div>'
            + '</div>'
