	...
	public function fetch($fetchType = null){
      ...
      switch(count($this->_pivotOn)){
            ...
            if($item instanceof Pivot_Callback){
							...
							if(isset($tmpCount[$k0][$reg[$split]][$reg[$column]][$item->getKey()])){
                $tmpCount[$k0][$reg[$split]][$reg[$column]][$item->getKey()] ++;
              }else{
                $tmpCount[$k0][$reg[$split]][$reg[$column]][$item->getKey()] = 1;
              }
				...
				case 2:
					...
					foreach($this->_columnValues as $item){
						if($item instanceof Pivot_Callback){
							...
							if(isset($tmpCount[$k0][$k1][$reg[$split]][$reg[$column]][$item->getKey()])){
                $tmpCount[$k0][$k1][$reg[$split]][$reg[$column]][$item->getKey()] ++;
              }else{
                $tmpCount[$k0][$k1][$reg[$split]][$reg[$column]][$item->getKey()] = 1;
              }
						}
						if(
						  isset($tmp[$k0][$k1][$reg[$split]][$reg[$column]][$item])
            ){
				...
				case 3:
					...
					foreach($this->_columnValues as $item){
						if($item instanceof Pivot_Callback){
							...
							if(isset($tmpCount[$k0][$k1][$k2][$reg[$split]][$reg[$column]][$item->getKey()])){
                $tmpCount[$k0][$k1][$k2][$reg[$split]][$reg[$column]][$item->getKey()] ++;
              }else{
                $tmpCount[$k0][$k1][$k2][$reg[$split]][$reg[$column]][$item->getKey()] = 1;
              }
						}
				...
				foreach($tmp as $p0 => $p0Values){
                  ...
                  if (isset($_lineTotal[$k])) {
                    ...
                    $_lineTotal[$k] = $value;
								...
								if($this->_fullTotal){
                  if (isset($fullTotal[$split][$col][$k])) {
