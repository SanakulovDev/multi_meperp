<?php
	...
	class m190805_053000_req_detail_plan extends Migration{
		...
		public function safeUp(){
			...
			$this->createIndex('frk-req_detail_plan-req_id', '{{%req_detail_plan}}', ['req_id'], false);
			$this->addForeignKey('fk_req_detail_plan_req_id',
			                     '{{%req_detail_plan}}', 'req_id',
			                     '{{%req}}', 'id',
			                     'CASCADE', 'CASCADE'
			);
		}
		...
		public function safeDown(){
			$this->dropIndex('frk-req_detail_plan-req_id', '{{%req_detail_plan}}');
			$this->dropForeignKey('fk_req_detail_plan_req_id', '{{%req_detail_plan}}');
			$this->dropTable('{{%req_detail_plan}}');
		}
	}
