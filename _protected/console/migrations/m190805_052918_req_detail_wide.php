<?php
	...
	class m190805_052918_req_detail_wide extends Migration{
		...
		public function safeUp(){
			...
			$this->createIndex('frk-req_detail_wide-req_id', '{{%req_detail_wide}}', ['req_id'], false);
		}

		public function safeDown(){
			$this->dropIndex('frk-req_detail_wide-req_id', '{{%req_detail_wide}}');
			$this->dropTable('{{%req_detail_wide}}');
		}
	}
