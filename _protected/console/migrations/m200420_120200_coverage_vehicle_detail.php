...
class m200420_120200_coverage_vehicle_detail extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addForeignKey('frk-coverage_vehicle_detail-coverage_vehicle_id','{{%coverage_vehicle_detail}}','coverage_vehicle_id','coverage_vehicle','id','cascade','cascade');

    }

    public function safeDown()
    {
        $this->dropIndex('frk-coverage_vehicle_detail-coverage_vehicle_id', '{{%coverage_vehicle_detail}}');
        $this->dropTable('{{%coverage_vehicle_detail}}');
    }
}
