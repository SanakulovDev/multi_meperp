...
class m191106_104143_req_detail_wide_t extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->createIndex('frk-req_detail_wide-req_id','{{%req_detail_wide_t}}',['req_id'],false);

    }

    public function safeDown()
    {
        $this->dropIndex('frk-req_detail_wide-req_id', '{{%req_detail_wide_t}}');
        $this->dropTable('{{%req_detail_wide_t}}');
    }
}
