<?php
    ...
    $this->title = Yii::t('app', 'Weekly Requirement Short');
    ...
    <div class="panel">
        <div class="row">
              <div class="col-md-8 row" style="display: flex; flex-direction: row; justify-content:start; align-items:center;">
                ...
                <div class="col-md-2">
                  <a href="<?= \yii\helpers\Url::to(['report/weekly-requirement-short', 'filter' => 1])?>" class="btn btn-success">Фильтр</a>
                </div>
                <div class="col-md-2">
                  <a href="<?= \yii\helpers\Url::to(['report/weekly-requirement-short'])?>" class="btn btn-danger">Очистить фильтра</a>
                </div>
              </div>
      ...
      <table class="table table-req" id="fix_table_d">
        <thead style="    position: sticky;top: 0;">
                  <tr class="tr_head" style="background-color: #c7c0c0;">
                      ...
                      <th style="width: 100px;" class="text-center">1 Неделю</th>
...
<?
    ...
    $(document).ready(function(){
      $('.requirement-part').on('change', function(e){
          ...
          let id = $(this).val();
          console.log(id);
          window.location.href = '/report/weekly-requirement-short?part_id='+id;
