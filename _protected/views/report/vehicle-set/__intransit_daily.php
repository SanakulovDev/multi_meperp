...
<tr>
      <td colspan="<?=count($period_daily_veh) + 2?>" style="height: 30px;"><b><?=Yii::t('app', 'INTRANSIT VOLUME');?></b></td>
      <td></td>
      <td></td>
      <td></td>
      <td></td>
    ...
    ?>
      ...
      <td></td>
      <? foreach ($period_daily_veh as $col => $pdate) { ?>
        <? $qty = $this->context->getVehicleDataByDate($data_vehicle_intransit,$model->id,$pdate);?>
