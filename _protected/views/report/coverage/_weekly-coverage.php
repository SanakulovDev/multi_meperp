...
<table class="table table-req" id="fix_table_w">
	...
	<thead>
		...
		<tr class="tr_head">
			...
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'WH balance') ?></th>
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'Line balance') ?></th>
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'Semi balance') ?></th>
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'Pending balance') ?></th>
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'Outsourcing balance') ?></th>
			<th style="width: 90px;" class="text-right"><?= Yii::t('app', 'Arrived') ?></th>
