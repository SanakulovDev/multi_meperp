...
/* @var $searchModel app\models\MoldSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = Yii::t('app', 'Mold');
$this->params['breadcrumbs'][] = $this->title;
$canUpdate = Yii::$app->user->can('mold-update');
$canDelete = Yii::$app->user->can('mold-delete');
?>
<div class="mold-index">

	<p class="pull-right">
    <?php
    if(Yii::$app->user->can('mold-create'))
