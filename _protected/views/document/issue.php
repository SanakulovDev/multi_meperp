  ...
  <div class="document-form">
    ...
    <div class="row">
      <div class="col-lg-10 col-sm-10">
        <?=$form->field($model, 'barcode')->textInput(['placeholder' => Yii::t('app', 'Scan barcode'), 'class' => 'form-control input-lg', 'id' => 'barcode', 'data-barcode-page' => 'issue','style' => 'font-size: 25px;', 'autofocus' => true])->label(false)?>
