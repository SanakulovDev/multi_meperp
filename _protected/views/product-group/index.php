...
$canUpdate = Yii::$app->user->can('product-group-update');
$canDelete = Yii::$app->user->can('product-group-delete');
$canCreate = Yii::$app->user->can('product-group-create');
?>
            ...
            [
                ...
                'buttons' => [
                    'update' => function($url, $model) use($canUpdate) {
                        ...
                        $url = Url::toRoute(['product-group/update', 'id' => $model->id]);
                        return Html::a(
                    ...
                    'delete' => function($url, $model) use($canDelete) {
                        ...
                        $url = Url::toRoute(['product-group/delete', 'id' => $model->id]);
