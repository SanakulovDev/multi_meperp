...
$canUpdate = Yii::$app->user->can('line-update');
$canDelete = Yii::$app->user->can('line-delete');
?>
<div class="line-index">

    <p class="pull-right">
      <?php
      if (Yii::$app->user->can('line-create'))
      ...
      if (Yii::$app->user->can('line-xls'))
        echo Html::a(Yii::t('app', 'btn-download'), ['xls', 'LineSearch' => ($_GET['LineSearch'] ?? null)],
          [
  ...
  <?= GridView::widget([
    ...
    'columns' => [
      ...
      [
        'attribute' => 'parent_id',
        'value' => function ($data) {
          return $data->parent ? $data->parent->line_name : '-';
        }
      ],
      [
