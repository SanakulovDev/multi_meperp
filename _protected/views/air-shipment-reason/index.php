...
/* @var $searchModel app\models\AirShipmentReasonSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Reason for Air shipment');
$this->params['breadcrumbs'][] = $this->title;

$canUpdate = Yii::$app->user->can('air-shipment-reason-update');
$canDelete = Yii::$app->user->can('air-shipment-reason-delete');

?>
<div class="air-shipment-reason-index">

    <p class="pull-right">
    <?php
	  if (Yii::$app->user->can('air-shipment-reason-create')) {
	  	echo Html::a(
