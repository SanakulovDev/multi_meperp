...
/* @var $searchModel app\models\PaymentTermSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Payment terms');
$this->params['breadcrumbs'][] = $this->title;
$canUpdate = Yii::$app->user->can('payment-term-update');
$canDelete = Yii::$app->user->can('payment-term-delete');
$canCreate = Yii::$app->user->can('payment-term-create');
?>
			...
			[
				...
				'buttons' => [
					'update' => function ($url, $model) use($canUpdate) {
						...
						$url = Url::toRoute(['payment-term/update', 'id' => $model->id]);
					...
					'delete' => function ($url, $model) use($canDelete) {
						...
						$url = Url::toRoute(['payment-term/delete', 'id' => $model->id]);
