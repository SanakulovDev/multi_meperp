  ...
  <div class="row" align="center" id="print_div" style="width:98%">
    ...
    <table class="inv_detail">
      <tr height="22">
        <td colspan="9" class="font_13 txt_center font_bold v_top">
          Счет-фактура № <?=$model->invoice_no;?> от <?=date("d.m.Y", strtotime($model->invoice_date));?> г.
        </td>
      </tr>
      <tr height="30">
        <td colspan="9" class="font_10 txt_center font_bold v_top">
          к товарно-отгрузочным документам: <?=$model->contract?> от <?=$model->contract_date?>
        </td>
      </tr>
      <tr height="37">
    ...
    <table class="inv_detail">
      <tr height="20" class="tr_border_thin font_bold txt_center">
        ...
        <td rowspan="2" class="font_8">Наим.товаров<br>(работ, услуг)</td>
        ...
        <td rowspan="2" class="font_8" style="width: 100px;">Стоимость<br>поставки</td>
        <td colspan="2" class="font_8" style="width: 140px;">НДС</td>
      ...
      $tno++;
      $vat = $model->vat;
      $ptno = $detail->part_no."(<span class='font_6'>".htmlspecialchars($detail->part_name)."</span>)";
    ...
    <table class="inv_detail">
      ...
      <tr height="28" class="font_9 v_middle tr_border_thin">
        ...
        <td class="p_left3" style="white-space: normal;"><?=$ptno?></td>
      ...
      <tr height="16" class="font_9 v_middle font_bold tr_border_thin">
        <td colspan="2" class="border_thin txt_right">Итого:</td>
    ...
    <table class="inv_detail">
      ...
      <tr height="40">
        <td colspan="5" class="font_10 v_bottom">
          <table style="width:100%">
            <tr>
              <td>Руководитель: <span class="font_bold"><?=$model->manager?></span></td>
      ...
      <tr height="40">
        <td colspan="5" class="font_10 v_bottom">
          <table style="width:100%">
            <tr>
              <td>Главный бухгалтер: <span class="font_bold"><?=$model->account?></span></td>
              <td class="font_bold poluchil_imzo" style="width:100%"></td>
            </tr>
          </table>
        </td>
