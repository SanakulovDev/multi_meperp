...
$this->title = Yii::t('app', 'Part mark');
$this->params['breadcrumbs'][] = $this->title;
$canUpdate = Yii::$app->user->can('part-mark-update');
$canDelete = Yii::$app->user->can('part-mark-delete');
$canCreate = Yii::$app->user->can('part-mark-create');
?>
            ...
            [
                ...
                'buttons' => [
                    'update' => function($url, $model) use($canUpdate) {
                        ...
                        $url = Url::toRoute(['part-mark/update', 'id' => $model->id]);
                        return Html::a(
                    ...
                    'delete' => function($url, $model) use($canDelete) {
                        ...
                        $url = Url::toRoute(['part-mark/delete', 'id' => $model->id]);
