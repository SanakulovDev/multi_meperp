...
/* @var $searchModel app\models\ConveyorTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Conveyor-type');
$this->params['breadcrumbs'][] = $this->title;
$canUpdate = Yii::$app->user->can('conveyor-type-update');
$canDelete = Yii::$app->user->can('conveyor-type-delete');
$canView = Yii::$app->user->can('conveyor-type-view');
?>
<div class="conveyor-type-index">

    <p class="pull-right">
		<? if (Yii::$app->user->can('conveyor-type-create')) { ?>
