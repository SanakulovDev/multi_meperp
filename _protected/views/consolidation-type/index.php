...
$this->title = Yii::t('app', 'Consolidation type');
$this->params['breadcrumbs'][] = $this->title;

$canUpdate = Yii::$app->user->can('consolidation-type-update');
$canDelete = Yii::$app->user->can('consolidation-type-delete');
?>
<div class="consolidation-type-index">

	<p class="pull-right">
		<? if (Yii::$app->user->can('consolidation-type-create')) { ?>
			<?= Html::a(
			...
			[
				...
				'buttons' => [
					'update' => function ($url, $model) use ($canUpdate) {
						...
						$url = Url::toRoute(['consolidation-type/update', 'id' => $model->id]);
					...
					'delete' => function ($url, $model) use ($canDelete) {
						...
						$url = Url::toRoute(['consolidation-type/delete', 'id' => $model->id]);
