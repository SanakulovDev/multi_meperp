...
$canUpdate = Yii::$app->user->can('receipt-waybill-update');
$canDelete = Yii::$app->user->can('receipt-waybill-delete');
$canCreate = Yii::$app->user->can('receipt-waybill-create');
$canDownload = Yii::$app->user->can('receipt-waybill-xls');
?>
	...
	<p class="pull-right">
		...
		if ($canDownload) {
			echo Html::a(
				...
				['xls', 'ReceiptWaybillSearch' => ($_GET['ReceiptWaybillSearch'] ?? null)],
				[
		...
		GridView::widget(
          ...
          [
            ...
            'value' => function ($model, $column) {
              return $model->receptControl->customer ? $model->receptControl->customer->name : '';
            }
					],
          [
            'attribute' => 'contract',
          ...
          [
            ...
            'value' => function ($model, $column) {
              return $model->waybill->waybill_no;
            }
          ],
					[
