...
$canXls = Yii::$app->user->can('stock-xls');
$partModel = new Part();
?>
<div class="stock-index">
  <p class="pull-right">
    <? if($canXls) { ?>
      <?=Html::a(Yii::t('app', 'btn-download'), ['xls', 'StockSearch' => ($_GET['StockSearch'] ?? null)], ['class' => 'btn btn-info btn-sm searchPjax', 'data-intro' => Yii::t('intro', 'stock-download')])?>
    <? } ?>
  </p>
  <?php Pjax::begin(); ?>
