...
<div class="box box-success">
  <div class="box-header with-border">
    <h3 class="box-title">More detailed info</h3>
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-7">
            <div class="chart-responsive">
              <canvas id="pieChart" height="160" width="625" style="width: 625px; height: 160px;"></canvas>
            </div>
            <!-- ./chart-responsive -->
          </div>
          <!-- /.col -->
          <div class="col-md-5">
            <ul class="chart-legend clearfix">
              ...
              <li><i class="fa fa-circle-o" style="color: <?=$row['color']?>"></i> <?=$row['role']?> - <b><?=$row['cnt']?></b></li>
              <?php } ?>
            </ul>
          </div>
          <!-- /.col -->
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="row">
          <div class="col-md-7">
            <div class="chart-responsive">
              <canvas id="pieChart2" height="160" width="625" style="width: 625px; height: 160px;"></canvas>
            </div>
            <!-- ./chart-responsive -->
          </div>
          <!-- /.col -->
          <div class="col-md-5">
            <ul class="chart-legend clearfix">
              <?php foreach($data['docs'] as $row){ ?>
                <li><i class="fa fa-circle-o" style="color: <?=$row['color']?>"></i> <?=$row['code']?> - <b><?=$row['cnt']?></b></li>
              <?php } ?>
            </ul>
          </div>
          <!-- /.col -->
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="row">
          <div class="col-md-7">
            <div class="chart-responsive">
              <canvas id="pieChart3" height="160" width="625" style="width: 625px; height: 160px;"></canvas>
            </div>
            <!-- ./chart-responsive -->
          </div>
          <!-- /.col -->
          <div class="col-md-5">
            <ul class="chart-legend clearfix">
               <?php foreach($data['whs'] as $row){ ?>
                <li><i class="fa fa-circle-o" style="color: <?=$row['color']?>"></i> <?=$row['type_name']?> - <b><?=$row['cnt']?></b></li>
              <?php } ?>
            </ul>
          </div>
          <!-- /.col -->
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="row">
          <div class="col-md-7">
            <div class="chart-responsive">
              <canvas id="pieChart4" height="160" width="625" style="width: 625px; height: 160px;"></canvas>
            </div>
            <!-- ./chart-responsive -->
          </div>
          <!-- /.col -->
          <div class="col-md-5">
            <ul class="chart-legend clearfix">
              ...
              <li><i class="fa fa-circle-o" style="color: <?=$row['color']?>"></i> <?=$row['state_name']?> - <b><?=$row['cnt']?></b></li>
              <?php }?>
            </ul>
          </div>
          <!-- /.col -->
  ...
  <div class="box-body">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="chart">
          <canvas id="lineChartVisits" style="height: 250px; width: 510px;" width="510" height="250"></canvas>
        </div>
      </div>
      <!-- /.box-body -->
    </div>
...
<?php if(isset($data['productionMonitor']['list'])): ?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <table class="table table-bordered">
            <?php
              $dates=$data['productionMonitor']['dates'];
              $warehouses=$data['productionMonitor']['warehouses'];
              $list=$data['productionMonitor']['list'];
            ?>
            <thead>
              <tr>
                <th rowspan="2" class="text-center" style="vertical-align: middle;"><?=Yii::t('app', 'Line')?></th>
            ...
            <tbody>
              <?php
                foreach ($warehouses as $wh) {
                  ...
                  foreach ($dates as $dt) {
                    $cols+=2;
                    $key1 = implode(';', [$dt, '1', $wh]);
                    $key2 = implode(';', [$dt, '2', $wh]);
                    if (isset($list[$key1]) && $list[$key1] == ProductionMonitor::STATUS_COMPLETED) {
                      $row .= '<td class="bg-success"></td>';
                    } else {
                      $danger++;
                      $row .= '<td class="bg-danger"></td>';
                    }
                    if (isset($list[$key2]) && $list[$key2] == ProductionMonitor::STATUS_COMPLETED) {
                      $row .= '<td class="bg-success"></td>';
                    } else {
                     $danger++;
                     $row .= '<td class="bg-danger"></td>';
