...
$canUpdate = Yii::$app->user->can('route-update');
$canDelete = Yii::$app->user->can('route-delete');
$canCreate =  Yii::$app->user->can('route-create');
?>
			...
			[
				...
				'buttons' => [
					'update' => function ($url, $model) use ($canUpdate) {
						...
						$url = Url::toRoute(['route/update', 'id' => $model->id]);
					...
					'delete' => function ($url, $model) use ($canDelete) {
						...
						$url = Url::toRoute(['route/delete', 'id' => $model->id]);
