...
/* @var $searchModel app\models\ContractSourceSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Contract sources');
$this->params['breadcrumbs'][] = $this->title;

$canUpdate = Yii::$app->user->can('contract-source-update');
$canDelete = Yii::$app->user->can('contract-source-delete');
?>
<div class="contract-source-index">

	<p class="pull-right">
		<? if (Yii::$app->user->can('contract-source-create')) { ?>
			<?= Html::a(
			...
			[
				...
				'buttons' => [
					'update' => function ($url, $model) use ($canUpdate) {
						...
						$url = Url::toRoute(['contract-source/update', 'id' => $model->id]);
					...
					'delete' => function ($url, $model) use ($canDelete) {
						...
						$url = Url::toRoute(['contract-source/delete', 'id' => $model->id]);
