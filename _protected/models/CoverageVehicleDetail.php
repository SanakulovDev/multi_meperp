...
/**
 * This is the model class for table "coverage_vehicle_detail".
 *
 * @property int $id
 ...
 *
 * @property CoverageVehicle $coverageVehicle
 */
class CoverageVehicleDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'coverage_vehicle_detail';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['type'], 'string', 'max' => 2],
            [['coverage_vehicle_id'], 'exist', 'skipOnError' => true, 'targetClass' => CoverageVehicle::className(), 'targetAttribute' => ['coverage_vehicle_id' => 'id']],
        ];
    }
     ...
     */
    public function getCoverageVehicle()
    {
        return $this->hasOne(CoverageVehicle::className(), ['id' => 'coverage_vehicle_id']);
    }
}
