...
/**
 * This is the model class for table "req_detail_wide".
 *
 * @property int $id
 * @property int $req_id
 ...
 * @property Req $req
 */
class ReqDetailWide extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return $this->hasOne(Req::className(), ['id' => 'req_id']);
    }
}
